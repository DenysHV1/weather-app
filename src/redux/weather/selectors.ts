...
export const selectIsError = (state: { weather: { isError: boolean } }) => state.weather.isError;
...
export const selectFuture = (state: { weather: { future: IFuture } }) => state.weather.future;
